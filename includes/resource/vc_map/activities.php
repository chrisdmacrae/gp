<?php
add_filter( 'vc_autocomplete_activities_cat_callback', 'actavista_TaxonomyAutocompleteSuggester', 10, 3 );
return array(
	'name'     => esc_html__( 'Our Activities', 'actavista' ),
	'base'     => 'activities',
	...
	'params'   => array(
		...
		array(
			'type'              => 'checkbox',
			'class'             => '',
			'param_name'        => 'show_blog_loc',
			'group'             => esc_html__( 'Show|Hide Options', 'actavista' ),
			'value'             => array( 'Enable Location' => 'true' ),
			'description'       => esc_html__( 'Enable to show location.', 'actavista' ),
		),
