<?php
return array( 
	'name' 			=> esc_html__( 'Register', 'actavista'  ),
    'base' 			=> 'register',
    ...
    array(
     ...
     array( 
        'type'              => 'checkbox',
        'class'             => '',
        'heading'           => esc_html__( 'Register Page Button Label', 'actavista' ),
        'param_name'        => 'login_btn',
        'admin_label'       =>  true,
        'value'             => array( 'Enable Login Page Button' => 'true' ),
