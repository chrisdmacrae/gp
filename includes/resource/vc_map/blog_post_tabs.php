<?php
add_filter( 'vc_autocomplete_blog_post_tabs_cat_callback', 'actavista_TaxonomyAutocompleteSuggester', 10, 3 );
return array(
	...
	'params'   => array(
		...
		array(
			'type'              => 'textfield',
			'class'             => '',
			'heading'           => esc_html__( 'Content Limit', 'actavista' ),
			'param_name'        => 'content_limit',
			'group'             => esc_html__( 'General Settings', 'actavista' ),
			'description'       => esc_html__( 'Enter content words limit.', 'actavista' ),
		),
		array(
			'type'              => 'checkbox',
			'class'             => '',
		...
		array(
			...
			'description'       => esc_html__( 'Enable to show post format icon.', 'actavista' ),
		),
	),
);
