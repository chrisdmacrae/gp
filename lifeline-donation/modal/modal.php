...
?>
    ...
    <div class="wpcm-wrapper donation-wrapper-content webinane-donation-moda">
        <slot>
        	<div class="donation-wrapper-content webinffane-donation-modal lifeline-dfonation-modal">
            <div class="donation-modal-box">
                <div class="donation-popup" style="display: block;" v-loading="loading">
                    <div class="wpcmddd-container">
                    
                        <div class="popup-cssentralize">
                          <span class="close" @click.prevent="showModalBox = false; closePopup()"><i class="fa fa-remove"></i></span>
