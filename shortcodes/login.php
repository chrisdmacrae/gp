	...
	<div class="row">
		...
		<div class="<?php echo esc_attr( $side_image || $logo_image ) ? 'col-lg-6' : 'col-lg-12'; ?> col-md-12 col-sm-12">
			<div class="login-area">
				...
				<form method="post" id="loginfom" action="<?php echo admin_url('admin-ajax.php') . '?action=actavista_ajax&subaction=actavista_login_form'; ?>" >
		<div class="row">
						<div class="col-lg-12 col-sm-12 col-xs-12">
							<input type="text" name="log" placeholder="<?php esc_attr_e('User Name', 'actavista'); ?>">
						</div>
						<div class="col-lg-12 col-sm-12 col-xs-12">
							<input type="password" name="pwd" placeholder="<?php esc_attr_e('Password', 'actavista'); ?>" >
						</div>

						<div class="col-lg-12 col-sm-12 col-xs-12">
							<button type="submit"> <?php echo esc_attr($label) ? ( $label  ) : esc_html_e('login now' , 'actavista'); ?></button>
